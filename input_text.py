...
class InputText:
	def __init__(self):
		...
		self.fix_text = "Introduce data:"
		self.user_text  = ""
		self.text_lines = []  # Store lines of text
		self.leftConer_x = 180
		self.leftConer_y = 10
		self.color = pygame.Color( (255, 255, 255))
		self.rect = pygame.Rect(self.leftConer_x,self.leftConer_y,350,40)
	...
	def runInputBox(self):
		while True:
			...
			self.screen.blit(current_text_surface,(170,20)) #( self.rect.x + 5, self.rect.y + 5))
